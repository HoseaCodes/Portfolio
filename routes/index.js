...
router.get('/', function (req, res, next) {
  const findResult = [
    { _id: 1, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://imgur.com/5xHWlqa.png"} },
    { _id: 2, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://i.imgur.com/0ykyWwZ.png"} },
    { _id: 3, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://i.imgur.com/0ykyWwZ.png"} },
    { _id: 4, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://i.imgur.com/0ykyWwZ.png"} },
    { _id: 5, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://i.imgur.com/0ykyWwZ.png"} },
    { _id: 6, address: { street: "123 Test"}, price: 90, images: {picture_url: "https://i.imgur.com/0ykyWwZ.png"} },
  ]
  const featured = [
    {_id: 1, show: true, demoLink: "https://hoseacodes-sortingstyles.netlify.app/", videoLink: "https://i.imgur.com/DmYfP9T.mp4",
      projectName: "Sorting Styles", githubLink: "https://github.com/HoseaCodes/Sorting-Style", 
      tags: ["JavaScript", "Node.js", "MongoDB", "Public API", "JSON"],
      iframe: "https://runkit.com/e/oembed-iframe?target=%2Fusers%2Fhoseacodes%2Frepositories%2Fsneaker-api.server.js%2Fdefault&referrer=",
    ...
    {_id: 2, show: true, demoLink: "https://sneaker-api-htx.herokuapp.com/", videoLink: "https://i.imgur.com/N3jaYVR.mp4",
      projectName: "Sneaker API", githubLink: "https://github.com/HoseaCodes/Sneaker-Api", 
      tags: ["JavaScript", "Node.js", "MongoDB", "Public API", "JSON"],
      iframe: "https://runkit.com/e/oembed-iframe?target=%2Fusers%2Fhoseacodes%2Frepositories%2Fsneaker-api.server.js%2Fdefault&referrer=",
    ...
    {_id: 3, show: false, demoLink: "https://careerconnect.herokuapp.com/", videoLink: "https://i.imgur.com/B0drFQI.mp4",
      projectName: "Career Connect", githubLink: "https://github.com/HoseaCodes/CareerConnect", 
    ...
    {_id: 4, show: true, demoLink: "https://devcenter-629.herokuapp.com/", videoLink: "https://i.imgur.com/pWRTkXg.mp4",
      projectName: "Dev Center", githubLink: "https://github.com/HoseaCodes/DevCenter", 
    ...
    {_id: 5, show: false, demoLink: "https://caloriekitchen.herokuapp.com/", videoLink: "https://i.imgur.com/fVzb6sP.mp4",
      projectName: "Calorie-Kitchen", githubLink: "https://github.com/HoseaCodes/Calorie-Kitchen", 
    ...
    {_id: 6, show: false, demoLink: "", videoLink: "https://i.imgur.com/lVi4QBi.mp4",
      projectName: "Pure CSS", githubLink: "https://github.com/HoseaCodes/Pure-css", 
      tags: ["Gatsby", "CSS"],
      iframe: "https://runkit.com/e/oembed-iframe?target=%2Fusers%2Fhoseacodes%2Frepositories%2Fsneaker-api.server.js%2Fdefault&referrer=",
  ...
  const wip = [
    {_id: 1, show: true, demoLink: "http://www.mergeimmersive.com/", videoLink: "https://i.imgur.com/bRK2U7B.png",
      projectName: "Merge-Immersive", githubLink: "https://github.com/HoseaCodes/merge-immersive", 
  ...
  const clients = [
    {_id: 1, show: true, demoLink: "http://www.social-ring.com/", videoLink: "https://i.imgur.com/CTXrMRw.mp4",
      projectName: "Social-Ring", githubLink: "https://github.com/HoseaCodes/Social-Ring-Web", 
      tags: ["JavaScript"],
      iframe: "https://runkit.com/e/oembed-iframe?target=%2Fusers%2Fhoseacodes%2Frepositories%2Fsneaker-api.server.js%2Fdefault&referrer=",
      description: `Social-Ring is a static website hosted on netlify. This website is built on with vanallia javascript.`
    },
    {_id: 2, show: true, demoLink: "https://pattongroup.github.io/StarterKit/", videoLink: "https://i.imgur.com/QcqJxi2.mp4",
      projectName: "Patton UniverCity Training", githubLink: "https://github.com/PattonGroup/StarterKit", 
      tags: ["JavaScript"],
      iframe: "https://runkit.com/e/oembed-iframe?target=%2Fusers%2Fhoseacodes%2Frepositories%2Fsneaker-api.server.js%2Fdefault&referrer=",
  ...
  res.render('index', { title: 'HoseaCodes', findResult, featured, wip, clients, images });
});
